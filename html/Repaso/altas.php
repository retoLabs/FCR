	...
	<div class="container">
		<div class="content">
			...
			if(isset($_POST['add'])){
				...
				$qry = mysqli_query($con, "SELECT * FROM usuarios WHERE usr='$usr'");
				if(mysqli_num_rows($qry) == 0){
					$insert = mysqli_query($con, "INSERT INTO usuarios (usr, pwd, rol)
						VALUES('$usr', '$pwd','$rol')") or die(mysqli_error());
						if($insert){
					...
					echo '<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Error. Usuario ya existe!</div>';
				}
			}
			?>
