...
if (!empty($_POST['usr']) && !empty($_POST['pwd']) && !empty($_POST['rol'])) {
	...
	// $stmt->bindParam(':password', $_POST['password']); // NO SE UTILIZA!
	...
	<div class="container">
		...
		<?php endif; ?>
			...
			<form class="form-horizontal" action="" method="post">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label">Membresía</label>
					<div class="col-sm-4">
						<input type="radio" name="rol" value="basico">Básico
				...
				<p>¿Ya tienes una cuenta? <a href="login.php">Haz login aquí</a></p>
			</form>
		</div>
	</div>
